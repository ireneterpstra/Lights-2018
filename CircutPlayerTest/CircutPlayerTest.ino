...
void loop() {
  ...
  /************* TEST CAPTOUCH */
//  Serial.print("Capsense #3: "); Serial.print(CircuitPlayground.readCap(3));
//  Serial.print("  Capsense #2: "); Serial.print(CircuitPlayground.readCap(2));
//  if (! CircuitPlayground.isExpress()) {  // CPX does not have this captouch pin
//    Serial.print("Capsense #0: "); Serial.print(CircuitPlayground.readCap(0));
//  }
//  Serial.print("  Capsense #1: "); Serial.print(CircuitPlayground.readCap(1));
//  Serial.print("  Capsense #12: "); Serial.print(CircuitPlayground.readCap(12));
//  Serial.print("  Capsense #6: "); Serial.print(CircuitPlayground.readCap(6));
//  Serial.print("  Capsense #9: "); Serial.print(CircuitPlayground.readCap(9));
//  Serial.print("  Capsense #10: "); Serial.print(CircuitPlayground.readCap(10));
