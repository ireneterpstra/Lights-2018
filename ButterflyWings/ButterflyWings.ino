...
Adafruit_NeoPixel strip2 = Adafruit_NeoPixel(numLeds2, PIN2, NEO_GRB + NEO_KHZ800);
...
void loop() {
  ...
  if (buttonCount == 0){
    ...
    Sparkle(255, 255, 26, 10, 20);
  } else if (buttonCount == 14){
    Sparkle(255, 153, 255, 10, 30);
  } else if (buttonCount == 15){
    Sparkle(0, 255, 153, 10, 20);
  } else if (buttonCount == 16){
    SparkleRainbow(10, 30);
  } else{
    buttonCount = 0;
  }
